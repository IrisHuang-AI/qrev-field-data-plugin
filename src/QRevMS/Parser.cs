...
namespace QRevMS
{
    public class Parser
    {
        ...
        {
            var dischargeActivityMapper = new DischargeActivityMapper(channel, fieldVisitInfo, Location);

            Appender.AddDischargeActivity(fieldVisitInfo, dischargeActivityMapper.MapDischargeActivityDetails());
        }
    }
}
